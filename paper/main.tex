...
\input{section3_physics}
\input{section3_method}
\input{section4_experiments}
\input{section5_discussion}
...
on IEEE DataPort.
Source code, hyperparameter configurations, and the experimental
snapshots underlying every figure and table (I1 frequency snapshots
and t-SNE feature caches) are available for peer review at the
anonymous repository
\url{https://anonymous.4open.science/r/bearmamba3-tim-supplementary-0E81},
and will be deposited to IEEE DataPort upon acceptance with a citable
DOI for permanent archival.
